...
ROOT::Experimental::TDataFrame MakeLazyDataFrame(std::pair<std::string, TResultPtr<std::vector<ColumnTypes>>> &&... colNameProxyPairs)
{
   ROOT::Experimental::TDataFrame tdf(std::make_unique<TLazyDS<ColumnTypes...>>(
